#!/usr/bin/env python
"""End-to-end driver for the HiRID MEDS ETL.
...
which is the one part of the ETL that is not yet expressible in MESSY (tar extraction,
wide-to-long reshaping, and the pseudotime derivation off `admissiontime`).
